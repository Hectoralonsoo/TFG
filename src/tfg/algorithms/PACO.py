...
from src.tfg.utils.evaluation import calcular_minutos_ponderados, calcular_costo_total
...
with open(DATA_DIR / "MoviesPlatform.json", "r", encoding="utf-8") as f:
    movies_by_platform = json.load(f)

with open(DATA_DIR / "SeriesPlatform.json", "r", encoding="utf-8") as f:
