...
from src.tfg.utils.logging_custom import observer, plot_evolution, plot_generation_improve, plot_pareto_front
...
def main():
    ...
    # Cambiado el directorio base
    base_results_path = "C:\\Users\\hctr0\\PycharmProjects\\TFG_Hector\\31Executions\\NSGA2"
    all_results = []
